...
EXPORTCALL(INT) WINAPI LTRAVR_ReadFlashParam(TLTRAVR *module, INT *PageSize, INT *FlashSize);
EXPORTCALL(INT) WINAPI LTRAVR_GetSignCode(TLTRAVR *module, DWORD *SignCode);
